  ...
  \item 
    ...
    \begin{recipe}{2}{Mackerell and Potato Hash}% Calories: 2690
		\begin{ingredients}
  ...
  \item 
    ...
    %
      \begin{shoppinglist}{Dairy}
      50 g cheddar cheese {\scriptsize[1-2]}\\
      150 g cheese {\scriptsize[3-4]}\\
  ...
  \item 
    ...
    \begin{recipe}{2}{Onion and Tomato Lasagna}% Calories: 2063
		\begin{ingredients}
  ...
  \item 
    ...
    %
      \begin{shoppinglist}{Dairy}
      250 g cheddar cheese {\scriptsize[3-4, 8-9]}\\
      200 g cheese {\scriptsize[10-11]}\\
  ...
  \item 
    ...
    \begin{recipe}{2}{Sweet Corn Pizza}% Calories: 858
		\begin{ingredients}
		2  pizza bases  \\
	300 g tomato puree  \\
	400 g tomatoes (chopped) \\
  ...
  \item 
    ...
    %
      \begin{shoppinglist}{Dairy}
      250 g cheddar cheese {\scriptsize[1-2]}\\
      250 g cottage cheese {\scriptsize[1-2]}\\
      2  eggs {\scriptsize[1-2]}\\
      1 tbsp parmesan cheese {\scriptsize[1-2]}\\
