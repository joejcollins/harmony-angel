    ...
    \begin{recipelist}
        ...
        {\scriptsize[5]} Cheese and tagliatelli\\
        {\scriptsize[6-7]} Chicken and Tomato Curry\\%
    \end{recipelist}%
    \begin{recipelist}
    
        {\scriptsize[8]} Bacon and Mushroom Pasta\\
    \end{recipelist}\par%
    ...
    %
      ...
      700 g carrots {\scriptsize[3-4, 6-7]}\\
      1  chillis {\scriptsize[1-2]}\\
      8 cloves garlic {\scriptsize[1-2, 6-7]}\\
      3 cm ginger {\scriptsize[6-7]}\\
      200 g kale {\scriptsize[1-2]}\\
      1  lemon {\scriptsize[1-2]}\\
      400 g onions {\scriptsize[6-7]}\\
    ...
    %
      ...
      800 g can tomatoes {\scriptsize[6-7]}\\
      ...
      400 ml red wine {\scriptsize[6-7]}\\
      50 g sunflower seeds {\scriptsize[3-4]}\\
      400 g tagliatelli {\scriptsize[5, 8]}\\
      140 g tomato puree {\scriptsize[6-7]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    ...
    %
      \begin{shoppinglist}{Dairy}
      25 g blue cheese {\scriptsize[5]}\\
      50 g butter {\scriptsize[3-4]}\\
      100 g cheese {\scriptsize[8]}\\
      180 g cream cheese {\scriptsize[1-2]}\\
      25 g gruyere cheese {\scriptsize[5]}\\
      4 tbsp milk {\scriptsize[3-4]}\\
      25 g parmesan {\scriptsize[5]}\\
      100 ml single cream {\scriptsize[5]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      \vfil\clearpage %
    ...
    %
      \begin{shoppinglist}{Groceries}
      800 g oven ready chips {\scriptsize[1]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
