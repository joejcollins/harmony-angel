    ...
    \begin{recipe}{2}{Spiced chicken}% Calories: 2114
		\begin{ingredients}
		400 g white rice  \\
    ...
    \begin{recipe}{2}{Tagliatelli and mushroom sauce}% Calories: 2452
		\begin{ingredients}
		400 g tagliatelli  \\
	400 g onions (chopped) \\
	3 tbsp oil  \\
    ...
    \begin{recipe}{2}{Chick pea and tomato curry}% Calories: 962
		\begin{ingredients}
		400 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Pasta and Bacon in white sauce}% Calories: 2312
		\begin{ingredients}
		400 g pasta shapes  \\
    ...
    \begin{recipe}{2}{Stir Fried Egg Rice}% Calories: 1112
		\begin{ingredients}
		400 g white rice  \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Tofu and Peppers}% Calories: 1034
		\begin{ingredients}
		400 g cous cous  \\
    ...
    \begin{recipe}{2}{Chicken with Cabbage and Peanuts}% Calories: 1387
		\begin{ingredients}
		400 g noodles  \\
	70 g peanuts  \\
	3 tbsp oil  \\
    ...
    \begin{recipe}{2}{Pea Risotto}% Calories: 1304
		\begin{ingredients}
		350 g onions (chopped) \\
	80 g butter  \\
	800 g frozen peas  \\
    ...
    \begin{recipe}{2}{Tofu and Tahini}% Calories: 2418
		\begin{ingredients}
		400 g onions (chopped) \\
	2 cloves garlic (crushed) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{2}{Spaghetti and Pasta Sauce}% Calories: 560
		\begin{ingredients}
		400 g onions  \\
	400 g minced meat  \\
    ...
    \begin{recipe}{2}{Vegetable Chilli Stew}% Calories: 1498
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Ethiopian Peanut Butter Curry}% Calories: 2571
		\begin{ingredients}
		400 g brown rice  \\
	2 tbsp oil  \\
	200 g onions (chopped) \\
    ...
    \begin{recipe}{1}{Puttanesca Spaghetti}% Calories: 584
		\begin{ingredients}
		200 g spaghetti  \\
    ...
    %
      ...
      400 g yoghurt {\scriptsize[12-13]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      \vfil\clearpage %
    ...
    \begin{recipe}{2}{Meat stew and dumplings}% Calories: 4151
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Leek Pasta Bake}% Calories: 1833
		\begin{ingredients}
		400 g pasta shapes  \\
	3 tbsp oil  \\
	800 g leeks (sliced) \\
    ...
    \begin{recipe}{2}{Curried Carrots}% Calories: 1689
		\begin{ingredients}
		400 g brown rice  \\
	3 tbsp oil  \\
	200 g onions (sliced) \\
    ...
    \begin{recipe}{1}{Pasta and pesto}% Calories: 264
		\begin{ingredients}
		200 g pasta shapes  \\
	100 g pesto  \\
	150 g can tuna fish  \\
    ...
    \begin{recipe}{2}{Norwegian Lamb and Cabbage}% Calories: 4942
		\begin{ingredients}
		1000 g lamb  \\
	1 tbsp plain flour  \\
    ...
    \begin{recipe}{2}{Green Shakshuka}% Calories: 2366
		\begin{ingredients}
		4 tbsp olive oil  \\
	600 g leeks (sliced) \\
    ...
    \begin{recipe}{2}{Parsnip and Carrot Couscous}% Calories: 1220
		\begin{ingredients}
    ...
    \begin{recipe}{1}{Spaghetti Carbonara}% Calories: 559
		\begin{ingredients}
		200 g spaghetti  \\
	2  eggs  \\
	100 ml milk  \\
    ...
    \begin{recipelist}
        ...
        {\scriptsize[10-11]} Parsnip, Mushroom and Barley\\
    ...
    %
      ...
      2 tbsp cashew nuts {\scriptsize[5-6]}\\
    ...
    %
      ...
      75 g butter {\scriptsize[3-4, 10-11]}\\
      180 g cream cheese {\scriptsize[1-2]}\\
      4  eggs {\scriptsize[14]}\\
      25 g gruyere cheese {\scriptsize[7]}\\
      8 tbsp milk {\scriptsize[3-4, 14]}\\
      25 g parmesan {\scriptsize[7]}\\
    ...
    \begin{recipe}{2}{Kale and Bacon Pasta}% Calories: 1898
		\begin{ingredients}
		400 g pasta shapes  \\
	250 g bacon (chopped) \\
	2 tbsp olive oil  \\
    ...
    \begin{recipe}{2}{Vegetable Shepherds Pie}% Calories: 1629
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Lentil and vegetable curry}% Calories: 1616
		\begin{ingredients}
		225 g red lentils  \\
	1 tsp cumin seeds  \\
	1 tsp mustard seeds  \\
    ...
    \begin{recipe}{1}{Cheese and tagliatelli}% Calories: 934
		\begin{ingredients}
		200 g tagliatelli  \\
	100 ml single cream  \\
    ...
    \begin{recipe}{2}{Chicken and Tomato Curry}% Calories: 1683
		\begin{ingredients}
		400 g onions (sliced) \\
	3 cm ginger (grated) \\
	4 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Parsnip, Mushroom and Barley}% Calories: 1955
		\begin{ingredients}
		200 g pearl barley  \\
    ...
    \item 
      ...
      \item 
        ...
        3~cloves crushed garlic
        until golden.
      \item 400~g sliced mushrooms1~tsp  mixed herbs\item 
      Bake 
      1200~g washed baking potatoes
      at
      (240$^{\circ}$C, Gas 9, 475$^{\circ}$F) for 40 minutes.
    ...
    \begin{recipe}{2}{Tomato tofu}% Calories: 1123
		\begin{ingredients}
		400 g onions (chopped) \\
    ...
    \begin{recipe}{1}{Scrambled Egg and Beans}% Calories: 1172
		\begin{ingredients}
		400 g baked beans  \\
	150 g red pepper (sliced) \\
	1 tbsp oil  \\
    ...
    \begin{recipelist}
        ...
        {\scriptsize[1-2]} Bean and Nut Roast\\
        {\scriptsize[3]} Bacon and Mushroom Pasta\\
        {\scriptsize[4-5]} Mackerell and Potato Hash\\
        {\scriptsize[6-7]} Banana Curry\\%
    \end{recipelist}%
    \begin{recipelist}
    
        {\scriptsize[8-9]} Beans and Bulgur wheat\\
        {\scriptsize[10]} Egg and Chips\\
    \end{recipelist}\par%
    ...
    %
      \begin{shoppinglist}{Vegetables}
      1200 g baking potatoes {\scriptsize[1-2]}\\
      1 cloves garlic {\scriptsize[1-2]}\\
      8 cm ginger {\scriptsize[6-7]}\\
      1000 g green bananas {\scriptsize[6-7]}\\
      2  green chilli {\scriptsize[6-7]}\\
      500 g mushrooms {\scriptsize[3, 4-5]}\\
      1000 g new potatoes {\scriptsize[4-5]}\\
      1150 g onions {\scriptsize[1-2, 4-5, 6-7]}\\
      300 g red pepper {\scriptsize[4-5]}\\
      %
      \end{shoppinglist}%
      %
      %
    %
      \begin{shoppinglist}{Groceries}
      2 tbsp branston pickle {\scriptsize[1-2]}\\
      4 tbsp bread {\scriptsize[1-2]}\\
      400 g brown rice {\scriptsize[6-7]}\\
      150 g bulgur wheat {\scriptsize[8-9]}\\
      1200 g can kidney beans {\scriptsize[1-2, 8-9]}\\
      400 g can tomatoes {\scriptsize[8-9]}\\
      800 g oven ready chips {\scriptsize[10]}\\
      100 g peanuts {\scriptsize[1-2]}\\
      200 g tagliatelli {\scriptsize[3]}\\
      225 g tomato puree {\scriptsize[1-2, 8-9]}\\
      2 tbsp whole grain mustard {\scriptsize[1-2]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    %
      \begin{shoppinglist}{Meat}
      100 g bacon {\scriptsize[3]}\\
      400 g smoked mackerel {\scriptsize[4-5]}\\
      %
      \end{shoppinglist}%
      %
      %
    %
      \begin{shoppinglist}{Dairy}
      100 g cheese {\scriptsize[3]}\\
      4  eggs {\scriptsize[10]}\\
      500 g yoghurt {\scriptsize[6-7]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      \vfil\clearpage %
    ...
    %
      \begin{shoppinglist}{Extra Vegetables}
      400 g broccoli {\scriptsize[8-9]}\\
      400 g carrots {\scriptsize[8-9]}\\
      250 g celery {\scriptsize[8-9]}\\
      4 cloves garlic {\scriptsize[8-9]}\\
      150 g green pepper {\scriptsize[8-9]}\\
      200 g onions {\scriptsize[8-9]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    ...
    \begin{recipe}{2}{Bean and Nut Roast}% Calories: 2373
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	350 g onions (chopped) \\
	1 cloves garlic (crushed) \\
    ...
    \begin{recipe}{1}{Bacon and Mushroom Pasta}% Calories: 1702
		\begin{ingredients}
		200 g tagliatelli  \\
	100 g bacon (chopped) \\
	200 g mushrooms (sliced) \\
    ...
    \begin{recipe}{2}{Mackerell and Potato Hash}% Calories: 2134
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Banana Curry}% Calories: 1763
		\begin{ingredients}
		400 g brown rice  \\
	400 g onions (chopped) \\
	2  green chilli (chopped) \\
    ...
    \begin{recipe}{2}{Beans and Bulgur wheat}% Calories: 1075
		\begin{ingredients}
		200 g onions (chopped) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{1}{Egg and Chips}% Calories: 0
		\begin{ingredients}
    ...
    \begin{recipelist}
        ...
        {\scriptsize[3-4]} Cheese Cous Cous\\
        {\scriptsize[5-6]} Bean and potato stew\\
        {\scriptsize[7-8]} Vegetable mousaka\\%
    \end{recipelist}%
    \begin{recipelist}
    ...
    %
      ...
      225 g tomato puree {\scriptsize[3-4, 7-8]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    ...
    %
      \begin{shoppinglist}{Dairy}
      150 g cheese {\scriptsize[7-8]}\\
      2  eggs {\scriptsize[7-8]}\\
      200 g halloumi cheese {\scriptsize[3-4]}\\
      200 ml milk {\scriptsize[7-8]}\\
      150 ml yoghurt {\scriptsize[7-8]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      \vfil\clearpage %
    ...
    %
      \begin{shoppinglist}{Extra Vegetables}
      1000 g aubergine {\scriptsize[7-8]}\\
      4 cloves garlic {\scriptsize[7-8]}\\
      100 g mushrooms {\scriptsize[7-8]}\\
      500 g new potatoes {\scriptsize[7-8]}\\
      400 g onions {\scriptsize[7-8]}\\
      500 g tomatoes {\scriptsize[7-8]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    ...
    \begin{recipe}{2}{Chicken Tagine}% Calories: 1544
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Cheese Cous Cous}% Calories: 1643
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Bean and potato stew}% Calories: 1192
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Vegetable mousaka}% Calories: 1489
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Tuna Bake}% Calories: 776
		\begin{ingredients}
		400 g brown rice  \\
	350 g onions (sliced) \\
	1  chillis (chopped) \\
    ...
    \begin{recipe}{2}{Onion and Tomato Lasagna}% Calories: 1630
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Tofu and Runner Bean Stir Fry}% Calories: 758
		\begin{ingredients}
		300 g tofu (cubed) \\
	7 tbsp oil  \\
	5 tbsp paprika  \\
    ...
    \begin{recipe}{2}{Chicken Curry}% Calories: 1462
		\begin{ingredients}
		400 g white rice  \\
	350 g onions (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Indian Tomatoes}% Calories: 529
		\begin{ingredients}
		4 tbsp oil  \\
	0.5 tsp asafoetida  \\
	0.5 tsp turmeric  \\
    ...
    %
      ...
      2 tbsp cashew nuts {\scriptsize[12-13]}\\
      400 ml cider {\scriptsize[8-9]}\\
      400 g cous cous {\scriptsize[12-13]}\\
      100 g creamed coconut {\scriptsize[10-11]}\\
      100 g flaked almonds {\scriptsize[1-2]}\\
    ...
    %
      ...
      400 g mange tout {\scriptsize[10-11]}\\
      800 g onions {\scriptsize[8-9, 10-11, 12-13]}\\
    ...
    \begin{recipe}{2}{Chicken Pilaf}% Calories: 1774
		\begin{ingredients}
		600 g chicken  \\
	200 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Chickpea Risotto}% Calories: 1036
		\begin{ingredients}
		400 g onions (chopped) \\
	1  red chilli (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Aubergine and Peppers}% Calories: 1990
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	350 g onions (sliced) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{1}{Beans and Fried Eggs}% Calories: 300
		\begin{ingredients}
		400 g baked beans  \\
	2  eggs  \\
	3 tbsp oil  \\
    ...
    \begin{recipe}{2}{Sausages in Cider}% Calories: 1014
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Egg Curry}% Calories: 1501
		\begin{ingredients}
		4  eggs  \\
	400 g white rice  \\
	350 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Lentil Dhansak}% Calories: 875
		\begin{ingredients}
		225 g red lentils  \\
	200 g onions (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{1}{Tortellini and Cheese}% Calories: 614
		\begin{ingredients}
		200 g tortellini  \\
    ...
    %
      \begin{shoppinglist}{Meat}
      106 g bacon {\scriptsize[1-2, 8-9]}\\
    ...
    %
      ...
      300 ml sour cream {\scriptsize[3-4]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      \vfil\clearpage %
    ...
    \begin{recipe}{2}{Lentils and Spicy Sausage}% Calories: 1246
		\begin{ingredients}
		400 g brown rice  \\
	350 g onions (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Russian Potatoes}% Calories: 2174
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Lentil Shepherds Pie}% Calories: 1171
		\begin{ingredients}
    ...
    \begin{recipe}{1}{Fish Fingers and Baked Beans}% Calories: 620
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Courgettes and Bacon}% Calories: 2188
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	400 g courgette (sliced) \\
	400 g onions (sliced) \\
    ...
    \begin{recipe}{2}{Sweet Corn Pizza}% Calories: 1268
		\begin{ingredients}
		2  pizza bases  \\
	300 g tomato puree  \\
	400 g tomatoes (chopped) \\
    ...
    \begin{recipe}{2}{Caribbean Beans}% Calories: 760
		\begin{ingredients}
		400 g white rice  \\
	350 g onions (chopped) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{1}{Tagliatelli and Olive Oil}% Calories: 742
		\begin{ingredients}
		200 g tagliatelli  \\
	4 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Spinach and Olive Lasagna}% Calories: 2128
		\begin{ingredients}
		4 tbsp oil  \\
	4 cloves garlic (crushed) \\
	400 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Chickpea and Spinach Curry}% Calories: 703
		\begin{ingredients}
		400 g brown rice  \\
	2 tsp cumin seeds  \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Sausage and Beans}% Calories: 2293
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	500 g sausages  \\
	350 g onions (sliced) \\
    ...
    \begin{recipe}{2}{Red Pepper Pasta}% Calories: 813
		\begin{ingredients}
		350 g onions (chopped) \\
	1  chillis (chopped) \\
    ...
    \begin{recipe}{2}{Vegetable Cous Cous}% Calories: 1260
		\begin{ingredients}
		200 g onions (chopped) \\
	2  red chilli (chopped) \\
    ...
    \begin{recipe}{2}{German Sausages, Mash and Sauerkraut}% Calories: 0
		\begin{ingredients}
		400 g sausages  \\
    ...
    \begin{recipe}{2}{Sweet and Sour Celery}% Calories: 768
		\begin{ingredients}
		400 g white rice  \\
	400 g celery (sliced) \\
	200 g onions (chopped) \\
    ...
    \begin{recipe}{1}{Pizza and Swedish salad}% Calories: 101
		\begin{ingredients}
		2  pizza  \\
    ...
    \begin{recipe}{2}{Coconut dahl}% Calories: 1020
		\begin{ingredients}
		400 g brown rice  \\
	225 g red lentils  \\
	50 g raisins  \\
    ...
    \begin{recipe}{1}{Spam and mustard pasta}% Calories: 992
		\begin{ingredients}
		200 g pasta shapes  \\
	2 tbsp oil  \\
	200 g spam (sliced) \\
    ...
    \begin{recipe}{2}{Lamb hotpot}% Calories: 2641
		\begin{ingredients}
		400 g lamb (sliced) \\
	400 g carrots (chopped) \\
	350 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Woolton Pie}% Calories: 2464
		\begin{ingredients}
		4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Mushroom Stew}% Calories: 839
		\begin{ingredients}
