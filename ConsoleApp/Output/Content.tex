    ...
    % Content Begins
		...
		\begin{menu}{First Menu}
    
    \begin{recipelist}
    Meat stew and dumplings\\Onion and tomato lasagna\\Chicken with cabbage and peanuts\\Beans and fried eggs in pitta\\%
    \end{recipelist}%
    \begin{recipelist}
    Egg and vegetable curry\\Lentil shepherds pie\\Chickpea risotto\\Tortellini and parmesan cheese\\%
    \end{recipelist}\par%
    ...
    \begin{recipelist}
    Egg and vegetable curry\\Egg and vegetable curry\\Egg and vegetable curry\\
    \end{recipelist}%
    \begin{recipelist}
