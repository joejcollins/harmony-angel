    ...
    \begin{recipelist}
        ...
        {\scriptsize[10-11]} Okonomiyaki (untested)\\
    ...
    %
      ...
      g mayonaise {\scriptsize[3-4, 10-11]}\\
    ...
    %
      ...
      8  eggs {\scriptsize[10-11, 10-11, 14]}\\
    ...
    \begin{recipe}{2}{Okonomiyaki (untested)}% Calories: 166
		\begin{ingredients}
		3 tbsp oil  \\
	200 g onions (sliced) \\
	3 cm ginger (grated) \\
    ...
    \item 
      ...
      \item 
        ...
        2~  eggs.
        and fry as pancakes.
        Half way through make a dip in the pancakes and break in 
      \item 
        Serve with 
        50~g chopped spring onions,
          mayonaise
    ...
    %
      ...
      400 g can kidney beans {\scriptsize[1-2]}\\
      800 g oven ready chips {\scriptsize[4]}\\
      100 g peanuts {\scriptsize[1-2]}\\
      200 g tagliatelli {\scriptsize[3]}\\
      75 g tomato puree {\scriptsize[1-2]}\\
    ...
    %
      ...
      2 cloves garlic {\scriptsize[1-2]}\\
      1  lemon {\scriptsize[1-2]}\\
      300 g onions {\scriptsize[1-2]}\\
      %
      \end{shoppinglist}%
      %
      %
