    ...
    %
      ...
      800 g cous cous {\scriptsize[7, 12-13]}\\
    ...
    \begin{recipe}{1}{Curry and couscous}% Calories: 1064
		\begin{ingredients}
		400 g can curry  \\
	400 g cous cous  \\
    ...
    \begin{recipe}{2}{Pasta and bacon in white sauce}% Calories: 1216
		\begin{ingredients}
		400 g pasta shapes  \\
    ...
    \begin{recipe}{2}{Tofu and peppers}% Calories: 704
		\begin{ingredients}
		400 g cous cous  \\
    ...
    %
      ...
      g baking potatoes {\scriptsize[5-6]}\\
    ...
    %
      ...
      400 g pasta shapes {\scriptsize[7]}\\
    ...
    \begin{recipe}{2}{Tofu and Tahini}% Calories: NaN
		\begin{ingredients}
		400 g onions (chopped) \\
	2 cloves garlic (crushed) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{1}{Pasta and Stir in Sauce}% Calories: 719
		\begin{ingredients}
		400 g pasta shapes  \\
    ...
    \begin{recipe}{2}{Vegetable Chilli Stew}% Calories: 728
		\begin{ingredients}
    ...
    %
      \begin{shoppinglist}{Vegetables}
      g baking potatoes {\scriptsize[1-2]}\\
    ...
    %
      ...
      800 g pasta shapes {\scriptsize[3-4, 7]}\\
    ...
    %
      \begin{shoppinglist}{Extra Vegetables}
      g baking potatoes {\scriptsize[8-9]}\\
    ...
    \begin{recipe}{2}{Meat stew and dumplings}% Calories: NaN
		\begin{ingredients}
		 g baking potatoes (washed) \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{1}{Pasta and pesto}% Calories: 528
		\begin{ingredients}
		400 g pasta shapes  \\
	100 g pesto  \\
	150 g can tuna fish  \\
    ...
    \begin{recipe}{2}{Norwegian Lamb and Cabbage}% Calories: NaN
		\begin{ingredients}
		1000 g lamb  \\
	1 tbsp plain flour  \\
    ...
    \begin{recipelist}
        ...
        {\scriptsize[10-11]} Tomato tofu\\
        {\scriptsize[12]} Scrambled Egg and Beans\\
    \end{recipelist}\par%
    ...
    %
      \begin{shoppinglist}{Groceries}
      400 g baked beans {\scriptsize[12]}\\
      400 g bread {\scriptsize[12]}\\
      400 g brown rice {\scriptsize[8-9]}\\
      400 g can borlotti beans {\scriptsize[3-4]}\\
      1600 g can tomatoes {\scriptsize[5-6, 8-9, 10-11]}\\
      ...
      400 g noodles {\scriptsize[10-11]}\\
      ...
      450 g tofu {\scriptsize[10-11]}\\
      290 g tomato puree {\scriptsize[8-9, 10-11]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    ...
    %
      ...
      50 g butter {\scriptsize[3-4]}\\
      180 g cream cheese {\scriptsize[1-2]}\\
      4  eggs {\scriptsize[12]}\\
      25 g gruyere cheese {\scriptsize[7]}\\
      8 tbsp milk {\scriptsize[3-4, 12]}\\
    ...
    %
      \begin{shoppinglist}{Extra Vegetables}
      600 g carrots {\scriptsize[8-9, 10-11]}\\
      6 cloves garlic {\scriptsize[8-9, 10-11]}\\
      3 cm ginger {\scriptsize[8-9]}\\
      100 g mushrooms {\scriptsize[10-11]}\\
      800 g onions {\scriptsize[8-9, 10-11]}\\
      300 g red pepper {\scriptsize[10-11, 12]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
    ...
    \begin{recipe}{2}{Tomato tofu}% Calories: 628
		\begin{ingredients}
		400 g onions (chopped) \\
    ...
    \begin{recipelist}
        ...
        {\scriptsize[4-5]} Beans and Bulgur wheat\\
        {\scriptsize[6]} Egg and Chips\\%
    \end{recipelist}%
    \begin{recipelist}
    ...
    %
      \begin{shoppinglist}{Vegetables}
      g baking potatoes {\scriptsize[1-2]}\\
      400 g broccoli {\scriptsize[4-5]}\\
      400 g carrots {\scriptsize[4-5]}\\
      250 g celery {\scriptsize[4-5]}\\
      5 cloves garlic {\scriptsize[1-2, 4-5]}\\
      150 g green pepper {\scriptsize[4-5]}\\
      200 g mushrooms {\scriptsize[3]}\\
      550 g onions {\scriptsize[1-2, 4-5]}\\
      %
      \end{shoppinglist}%
      %
      %
    %
      ...
      150 g bulgur wheat {\scriptsize[4-5]}\\
      1200 g can kidney beans {\scriptsize[1-2, 4-5]}\\
      400 g can tomatoes {\scriptsize[4-5]}\\
      800 g oven ready chips {\scriptsize[6]}\\
      100 g peanuts {\scriptsize[1-2]}\\
      200 g tagliatelli {\scriptsize[3]}\\
      225 g tomato puree {\scriptsize[1-2, 4-5]}\\
    ...
    \begin{recipe}{2}{Bean and Nut Roast}% Calories: NaN
		\begin{ingredients}
		 g baking potatoes (washed) \\
	350 g onions (chopped) \\
	1 cloves garlic (crushed) \\
    ...
    \begin{recipelist}
        ...
        {\scriptsize[3-4]} Bean and potato stew\\
    \end{recipelist}%
    \begin{recipelist}
    ...
    %
      \begin{shoppinglist}{Vegetables}
      400 g aubergine {\scriptsize[3-4]}\\
      1000 g courgette {\scriptsize[3-4]}\\
      ...
      700 g onions {\scriptsize[1-2, 3-4]}\\
    ...
    \begin{recipe}{2}{Tofu and Runner Bean Stir Fry}% Calories: 428
		\begin{ingredients}
		300 g tofu (cubed) \\
	7 tbsp oil  \\
	5 tbsp paprika  \\
    ...
    \begin{recipe}{2}{Aubergine and Peppers}% Calories: NaN
		\begin{ingredients}
		 g baking potatoes (washed) \\
	350 g onions (sliced) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Courgettes and Bacon}% Calories: NaN
		\begin{ingredients}
		 g baking potatoes (washed) \\
	400 g courgette (sliced) \\
	400 g onions (sliced) \\
    ...
    \begin{recipe}{2}{Sausage and Beans}% Calories: NaN
		\begin{ingredients}
		 g baking potatoes (washed) \\
	500 g sausages  \\
	350 g onions (sliced) \\
    ...
    %
      ...
      400 g pasta shapes {\scriptsize[8]}\\
    ...
    \begin{recipe}{1}{Spam and mustard pasta}% Calories: 1256
		\begin{ingredients}
		400 g pasta shapes  \\
	2 tbsp oil  \\
	200 g spam (sliced) \\
    ...
    \begin{recipe}{2}{Lamb hotpot}% Calories: 1486
		\begin{ingredients}
		400 g lamb (sliced) \\
	400 g carrots (chopped) \\
	350 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Woolton Pie}% Calories: 1694
		\begin{ingredients}
		4 tbsp oil  \\
