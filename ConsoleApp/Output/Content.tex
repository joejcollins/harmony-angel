    ...
    \begin{recipelist}
        ...
        {\scriptsize[6-7]} Curried Carrots\\%
    \end{recipelist}%
    \begin{recipelist}
    ...
    \item 1000~g  lamb,
        1~tbsp  plain flour,
        1000~g quartered cabbage1~tbsp  black pepper corns\item 
      Bake 1200~g washed baking potatoes
      at
    ...
    \item 
     ...
     for 45 minutes.
      \item 
        ...
        3~tbsp  cold water
        and form into dough.
        Roll out and cover the vegetables when they are done.
        bake 
      (200$^{\circ}$C, Gas 5, 380$^{\circ}$F)
     for futher 15 minutes.
      \item 
        In a sauce pan mix
        4~tsp  gravy granules
        and
