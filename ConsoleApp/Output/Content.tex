    ...
    \begin{recipe}{2}{Spiced chicken}% Calories: 2608
		\begin{ingredients}
		400 g white rice  \\
    ...
    \begin{recipe}{2}{Tagliatelli and mushroom sauce}% Calories: 2822
		\begin{ingredients}
		400 g tagliatelli  \\
	400 g onions (chopped) \\
	3 tbsp oil  \\
    ...
    \begin{recipe}{2}{Chick pea and tomato curry}% Calories: 1209
		\begin{ingredients}
		400 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Pasta and Bacon in white sauce}% Calories: 2748
		\begin{ingredients}
		400 g pasta shapes  \\
    ...
    \begin{recipe}{2}{Stir Fried Egg Rice}% Calories: NaN
		\begin{ingredients}
		400 g white rice  \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Tofu and Peppers}% Calories: 1404
		\begin{ingredients}
		400 g cous cous  \\
    ...
    \begin{recipe}{2}{Tofu and Tahini}% Calories: 2911
		\begin{ingredients}
		400 g onions (chopped) \\
	2 cloves garlic (crushed) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{2}{Spaghetti and Pasta Sauce}% Calories: 2000
		\begin{ingredients}
		400 g onions  \\
	400 g minced meat  \\
    ...
    \begin{recipe}{2}{Vegetable Chilli Stew}% Calories: 1992
		\begin{ingredients}
    ...
    \begin{recipe}{1}{Puttanesca Spaghetti}% Calories: 981
		\begin{ingredients}
		200 g spaghetti  \\
    ...
    \begin{recipe}{2}{Meat stew and dumplings}% Calories: 4682
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Leek Pasta Bake}% Calories: 2392
		\begin{ingredients}
		400 g pasta shapes  \\
	3 tbsp oil  \\
	800 g leeks (sliced) \\
    ...
    \begin{recipe}{2}{Curried Carrots}% Calories: 2059
		\begin{ingredients}
		400 g brown rice  \\
	3 tbsp oil  \\
	200 g onions (sliced) \\
    ...
    \begin{recipe}{1}{Pasta and pesto}% Calories: 798
		\begin{ingredients}
		200 g pasta shapes  \\
	100 g pesto  \\
	150 g can tuna fish  \\
    ...
    \begin{recipe}{2}{Norwegian Lamb and Cabbage}% Calories: 4332
		\begin{ingredients}
		800 g lamb  \\
	1 tbsp plain flour  \\
    ...
    \begin{recipe}{2}{Green Shakshuka}% Calories: 2864
		\begin{ingredients}
		4 tbsp olive oil  \\
	600 g leeks (sliced) \\
    ...
    \begin{recipe}{2}{Parsnip and Carrot Couscous}% Calories: 2072
		\begin{ingredients}
    ...
    \begin{recipe}{1}{Spaghetti Carbonara}% Calories: 609
		\begin{ingredients}
		200 g spaghetti  \\
	2  eggs  \\
	100 ml milk  \\
    ...
    \begin{recipelist}
        ...
        {\scriptsize[10-11]} Parsnip and Barley Roast\\
    ...
    \begin{recipe}{2}{Kale and Bacon Pasta}% Calories: 2142
		\begin{ingredients}
		400 g pasta shapes  \\
	250 g bacon (chopped) \\
	2 tbsp olive oil  \\
    ...
    \begin{recipe}{2}{Vegetable Shepherds Pie}% Calories: 1657
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Lentil and vegetable curry}% Calories: 2109
		\begin{ingredients}
		225 g red lentils  \\
	1 tsp cumin seeds  \\
	1 tsp mustard seeds  \\
    ...
    \begin{recipe}{2}{Chicken and Tomato Curry}% Calories: 2670
		\begin{ingredients}
		400 g onions (sliced) \\
	3 cm ginger (grated) \\
	4 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Parsnip and Barley Roast}% Calories: 2406
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Tomato tofu}% Calories: 1493
		\begin{ingredients}
		400 g onions (chopped) \\
    ...
    \begin{recipe}{1}{Scrambled Egg and Beans}% Calories: 1330
		\begin{ingredients}
		400 g baked beans  \\
	150 g red pepper (sliced) \\
	1 tbsp oil  \\
    ...
    \begin{recipe}{2}{Bean and Nut Roast}% Calories: 2620
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	350 g onions (chopped) \\
	1 cloves garlic (crushed) \\
    ...
    \begin{recipe}{1}{Bacon and Mushroom Pasta}% Calories: 1825
		\begin{ingredients}
		200 g tagliatelli  \\
	100 g bacon (chopped) \\
	200 g mushrooms (sliced) \\
    ...
    \begin{recipe}{2}{Mackerell and Potato Hash}% Calories: 2504
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Banana Curry}% Calories: 2503
		\begin{ingredients}
		400 g brown rice  \\
	400 g onions (chopped) \\
	2  green chilli (chopped) \\
    ...
    \begin{recipe}{2}{Beans and Bulgur wheat}% Calories: 1321
		\begin{ingredients}
		200 g onions (chopped) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{1}{Egg and Chips}% Calories: 1745
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Chicken Tagine}% Calories: NaN
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Cheese Cous Cous}% Calories: 2281
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Bean and potato stew}% Calories: 1809
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Vegetable mousaka}% Calories: 2080
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Tuna Bake}% Calories: 1269
		\begin{ingredients}
		400 g brown rice  \\
	350 g onions (sliced) \\
	1  chillis (chopped) \\
    ...
    \begin{recipe}{2}{Onion and Tomato Lasagna}% Calories: 2047
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Tofu and Runner Bean Stir Fry}% Calories: 1621
		\begin{ingredients}
		300 g tofu (cubed) \\
	7 tbsp oil  \\
	5 tbsp paprika  \\
    ...
    \begin{recipe}{2}{Chicken Curry}% Calories: 1832
		\begin{ingredients}
		400 g white rice  \\
	350 g onions (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Indian Tomatoes}% Calories: 1023
		\begin{ingredients}
		4 tbsp oil  \\
	0.5 tsp asafoetida  \\
	0.5 tsp turmeric  \\
    ...
    \begin{recipe}{2}{Chicken Pilaf}% Calories: 2267
		\begin{ingredients}
		600 g chicken  \\
	200 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Chickpea Risotto}% Calories: 1283
		\begin{ingredients}
		400 g onions (chopped) \\
	1  red chilli (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Aubergine and Peppers}% Calories: 2483
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	350 g onions (sliced) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{1}{Beans and Fried Eggs}% Calories: 683
		\begin{ingredients}
		400 g baked beans  \\
	2  eggs  \\
	3 tbsp oil  \\
    ...
    \begin{recipe}{2}{Sausages in Cider}% Calories: 1015
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Egg Curry}% Calories: 1877
		\begin{ingredients}
		4  eggs  \\
	400 g white rice  \\
	350 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Lentils and Spicy Sausage}% Calories: 1616
		\begin{ingredients}
		400 g brown rice  \\
	350 g onions (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Russian Potatoes}% Calories: 2186
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Lentil Shepherds Pie}% Calories: 1418
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Courgettes and Bacon}% Calories: 2499
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	400 g courgette (sliced) \\
	400 g onions (sliced) \\
    ...
    \begin{recipe}{2}{Caribbean Beans}% Calories: 1130
		\begin{ingredients}
		400 g white rice  \\
	350 g onions (chopped) \\
	150 g green pepper (chopped) \\
    ...
    \begin{recipe}{1}{Tagliatelli and Olive Oil}% Calories: 1530
		\begin{ingredients}
		200 g tagliatelli  \\
	4 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Spinach and Olive Lasagna}% Calories: 2924
		\begin{ingredients}
		4 tbsp oil  \\
	4 cloves garlic (crushed) \\
	400 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Chickpea and Spinach Curry}% Calories: 1196
		\begin{ingredients}
		400 g brown rice  \\
	2 tsp cumin seeds  \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Sausage and Beans}% Calories: 2786
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	500 g sausages  \\
	350 g onions (sliced) \\
    ...
    \begin{recipe}{2}{Red Pepper Pasta}% Calories: 1306
		\begin{ingredients}
		350 g onions (chopped) \\
	1  chillis (chopped) \\
    ...
    \begin{recipe}{2}{Vegetable Cous Cous}% Calories: 1754
		\begin{ingredients}
		200 g onions (chopped) \\
	2  red chilli (chopped) \\
    ...
    \begin{recipe}{2}{Sweet and Sour Celery}% Calories: 1561
		\begin{ingredients}
		400 g white rice  \\
	400 g celery (sliced) \\
	200 g onions (chopped) \\
    ...
    \begin{recipe}{1}{Pizza and Swedish salad}% Calories: 347
		\begin{ingredients}
		2  pizza  \\
    ...
    \begin{recipe}{2}{Coconut dahl}% Calories: 1143
		\begin{ingredients}
		400 g brown rice  \\
	225 g red lentils  \\
	50 g raisins  \\
    ...
    \begin{recipe}{1}{Spam and mustard pasta}% Calories: 1239
		\begin{ingredients}
		200 g pasta shapes  \\
	2 tbsp oil  \\
	200 g spam (sliced) \\
    ...
    \begin{recipe}{2}{Woolton Pie}% Calories: 2959
		\begin{ingredients}
		4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Mushroom Stew}% Calories: 1086
		\begin{ingredients}
