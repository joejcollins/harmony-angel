    ...
    \begin{recipelist}
        ...
        {\scriptsize[4-5]} Banana Curry\\
        {\scriptsize[6-7]} Beans and Bulgur wheat\\%
    \end{recipelist}%
    \begin{recipelist}
    
        {\scriptsize[8]} Egg and Chips\\
    \end{recipelist}\par%
    ...
    %
      \begin{shoppinglist}{Vegetables}
      1200 g baking potatoes {\scriptsize[1-2]}\\
      400 g broccoli {\scriptsize[6-7]}\\
      400 g carrots {\scriptsize[6-7]}\\
      250 g celery {\scriptsize[6-7]}\\
      5 cloves garlic {\scriptsize[1-2, 6-7]}\\
      8 cm ginger {\scriptsize[4-5]}\\
      1000 g green bananas {\scriptsize[4-5]}\\
      2  green chilli {\scriptsize[4-5]}\\
      150 g green pepper {\scriptsize[6-7]}\\
      200 g mushrooms {\scriptsize[3]}\\
      950 g onions {\scriptsize[1-2, 4-5, 6-7]}\\
      %
      \end{shoppinglist}%
      %
      %
    %
      ...
      400 g brown rice {\scriptsize[4-5]}\\
      150 g bulgur wheat {\scriptsize[6-7]}\\
      1200 g can kidney beans {\scriptsize[1-2, 6-7]}\\
      400 g can tomatoes {\scriptsize[6-7]}\\
      800 g oven ready chips {\scriptsize[8]}\\
      100 g peanuts {\scriptsize[1-2]}\\
      200 g tagliatelli {\scriptsize[3]}\\
      225 g tomato puree {\scriptsize[1-2, 6-7]}\\
    ...
    %
      ...
      75 g tomato puree {\scriptsize[3-4]}\\
      %
      \end{shoppinglist}%
      \par\vfil %
      %
