    ...
    \begin{recipe}{2}{Spiced chicken}% Calories: 2656
		\begin{ingredients}
		400 g white rice  \\
    ...
    \begin{recipe}{2}{Chick pea and tomato curry}% Calories: 1685
		\begin{ingredients}
		400 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Stir Fried Egg Rice}% Calories: 1969
		\begin{ingredients}
		400 g white rice  \\
	4 tbsp oil  \\
    ...
    \begin{recipe}{2}{Vegetable Chilli Stew}% Calories: 2454
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Green Shakshuka}% Calories: 3108
		\begin{ingredients}
		4 tbsp olive oil  \\
	600 g leeks (sliced) \\
    ...
    \begin{recipe}{2}{Parsnip and Barley Nut Roast}% Calories: 3009
		\begin{ingredients}
    ...
    \begin{recipe}{1}{Scrambled Egg and Beans}% Calories: 1390
		\begin{ingredients}
		400 g baked beans  \\
	150 g red pepper (sliced) \\
	1 tbsp oil  \\
    ...
    \begin{recipe}{2}{Halloumi Couscous}% Calories: 2439
		\begin{ingredients}
    ...
    \begin{recipe}{1}{Strammer Max}% Calories: 1153
		\begin{ingredients}
		400 g bread (sliced) \\
	50 g cheese  \\
	2  eggs  \\
    ...
    \begin{recipe}{2}{Vegetable Mousaka}% Calories: 2192
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Indian Tomatoes}% Calories: 1203
		\begin{ingredients}
		4 tbsp oil  \\
	0.5 tsp asafoetida  \\
	0.5 tsp turmeric  \\
    ...
    \begin{recipe}{2}{Chickpea Risotto}% Calories: 3614
		\begin{ingredients}
		400 g onions (chopped) \\
	1  red chilli (chopped) \\
	2 cloves garlic (crushed) \\
    ...
    \begin{recipe}{1}{Beans and Fried Eggs}% Calories: 719
		\begin{ingredients}
		400 g baked beans  \\
	2  eggs  \\
	3 tbsp oil  \\
    ...
    \begin{recipe}{2}{Sausages in Cider}% Calories: 2520
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Egg Curry}% Calories: 2045
		\begin{ingredients}
		4  eggs  \\
	400 g white rice  \\
	350 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Russian Potatoes}% Calories: 3419
		\begin{ingredients}
    ...
    \begin{recipe}{2}{Courgettes and Bacon}% Calories: 3849
		\begin{ingredients}
		1200 g baking potatoes (washed) \\
	400 g courgette (sliced) \\
	400 g onions (sliced) \\
    ...
    \begin{recipe}{1}{Tagliatelli and Olive Oil}% Calories: 1840
		\begin{ingredients}
		200 g tagliatelli  \\
	4 cloves garlic (crushed) \\
    ...
    \begin{recipe}{2}{Spinach and Olive Lasagna}% Calories: 3213
		\begin{ingredients}
		4 tbsp oil  \\
	4 cloves garlic (crushed) \\
	400 g onions (chopped) \\
    ...
    \begin{recipe}{2}{Red Pepper Pasta}% Calories: 1767
		\begin{ingredients}
		350 g onions (chopped) \\
	1  chillis (chopped) \\
    ...
    \begin{recipe}{2}{Vegetable Cous Cous}% Calories: 3023
		\begin{ingredients}
		200 g onions (chopped) \\
	2  red chilli (chopped) \\
    ...
    \begin{recipe}{2}{Woolton Pie}% Calories: 3149
		\begin{ingredients}
		4 tbsp oil  \\
